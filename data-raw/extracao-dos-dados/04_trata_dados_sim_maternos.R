...
#     ),
#
#     obitos_maternos_diretos_demais_causas = if_else(
#       obitos_maternos_diretos == 1 &
#         obitos_maternos_diretos_aborto == 0 &
#         obitos_maternos_diretos_hipertensao == 0 &
#         obitos_maternos_diretos_hemorragia == 0 &
#         obitos_maternos_diretos_infec_puerperal == 0,
#       1, 0, missing = 0
#     ),
#
...
#       1, 0, missing = 0
#     ),
#     obitos_maternos_indiretos_demais_causas = if_else(
#       obitos_maternos_indiretos == 1 &
#         obitos_maternos_indiretos_aids == 0 &
#         obitos_maternos_indiretos_circulatorio == 0 &
#         obitos_maternos_indiretos_respiratorio == 0 &
#         obitos_maternos_indiretos_infecciosas == 0,
#       1, 0, missing = 0
#     ),
#
#
